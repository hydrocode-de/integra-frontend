            ...
            <Layer id="tree-locations" source="tree-locations" type="symbol"
                layout={{
                    ...
                    'icon-size': [
                        ...
                        19, ['interpolate', ['linear'], ['get', 'height'], 0, 0.2, 25, 1.5],
                        19.5, ['interpolate', ['linear'], ['get', 'height'], 0, 0.3, 25, 2],
                        20, ['interpolate', ['linear'], ['get', 'height'], 0, 0.4, 25, 2.3],
                        20.3, ['interpolate', ['linear'], ['get', 'height'], 0, 0.5, 25, 2.5],
                        20.6, ['interpolate', ['linear'], ['get', 'height'], 0, 0.6, 25, 2.9],
                        21, ['interpolate', ['linear'], ['get', 'height'], 0, 0.7, 25, 3],
                        21.3, ['interpolate', ['linear'], ['get', 'height'], 0, 0.8, 25, 3.5],
                        21.6, ['interpolate', ['linear'], ['get', 'height'], 0, 0.9, 25, 4],
                        22, ['interpolate', ['linear'], ['get', 'height'], 0, 1, 25, 4.5],
                    ],
