  ...
  return (
    <>
      ...
      <Grid container spacing={0}>
        <Grid item xs={6}>
          <Typography variant="h4">{(totalStatistics.value.count || 0).toFixed(0)}</Typography>
          <Typography variant="subtitle2">Bäume gesamt</Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="h4">{(totalStatistics.value.countPerHectare || 0).toFixed(0)}</Typography>
          <Typography variant="subtitle2">Bäume pro Hektar</Typography>
        </Grid>
      </Grid>
    </>
  );
